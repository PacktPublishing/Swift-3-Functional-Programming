...
## Instructions
To follow along with the examples from chapters 1 to 10 in this book, you'll need to have an Apple computer with macOS installed. You'll also need to install Xcode version 8 beta 2 with Swift 3.0 Preview 1.

Chapter 11 - Frontend App requires Xcode 7.3.1 as used dependencies are not updated to Swift 3.0 preview 1 specifications yet.
