...
let result = simpleMathOperator(3.0, 4.0) // result is 15
...
print("The result is \(calculateResult(simpleMathOperator, a: 3.5, b: 5.5))") // prints “The result is 9.0”
...
let chosenOperator = choosePlusMinus(true)
